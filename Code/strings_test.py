...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        assert contains('unfortunate', 'tuna') is True
        assert contains('this is a test', 's is a') is True
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        assert contains('unfortunate', 'tunas') is False
        assert contains('this is a test', 'sis a') is False
    ...
    def test_contains_with_complex_patterns(self):
        ...
        assert contains('test the full sentence', 'test the full sentence') is True
        assert contains('', '') is True # test an empty string
        assert contains('abba', 'ba') is True
        assert contains('ababac', 'abac') is True
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        assert find_index('', '') == 0
        assert find_index('unfortunate', 'tuna') == 5
    ...
    def test_find_index_with_non_matching_patterns(self):
        ...
        assert find_index('unfortunate', 'tunas') is None
    ...
    def test_find_index_with_complex_patterns(self):
        ...
        # TODO: Write more test cases that check complex patterns or edge cases
        # You'll need a lot more than this to test your algorithm's robustness
        assert find_index('testing', 'sting') == 2
        assert find_index('aabacbaad', 'baad') == 5
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        assert find_all_indexes('ababa', 'ab') == [0,2]
        assert find_all_indexes('abacabac', 'bac') == [1,5]
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        assert find_all_indexes('abacabac', 'bacac') == []
        assert find_all_indexes('', 'a') == []
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        # TODO: Write more test cases that check complex patterns or edge cases
        # You'll need a lot more than this to test your algorithm's robustness
        assert find_all_indexes('abababab', 'bab') == [1,3,5]
